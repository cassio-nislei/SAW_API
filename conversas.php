                        ...
                        <div class="_1NrpZ" id="pane-side" data-list-scroll-container="true">
                            <div tabindex="-1" data-tab="3">
                                <div>
                                    <!-- Conversas -->
                                    <div class="RLfQR">
                                                <span onclick="toggleList('ListaTriagem', 'counterTriagemValue')">
                                        ...
                                        <!-- Lista os Atendimentos Triagem Sem Departamento -->
                                                ...
                                                <div class="RLfQR">
                                                <span onclick="toggleList('ListaPendentes', 'counterPendentesValue')">
                                        ...
                                        <!-- Lista os Atendimentos Em Espera -->
                                                ...
                                                <div class="RLfQR">
                                                <span  onclick="toggleList('ListaEmAtendimento', 'counterEmAtendimentoValue')">
