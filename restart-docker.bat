@echo off
REM Script para reiniciar Docker Compose - Resolve conflitos de porta
...
echo Digite 'y' e ENTER se quiser remover dados antigos:
set /p remove_data="Remover dados? (y/n): "
if /i "%remove_data%"=="y" (
